...
Shader "StencilSphereShader"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_FresnelScale("FresnelScale", Float) = 0
		_FresnelPower("FresnelPower", Float) = 0
		[HDR]_FresnelColor("FresnelColor", Color) = (0,0,0,0)
		_Speed("Speed", Float) = 3.45
		[ASEEnd]_FresScale("FresScale", Float) = 41.35
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_15_0 = ( _TimeParameters.x * _Speed );
				float time13 = temp_output_15_0;
				float2 coords13 = IN.ase_texcoord7.xy * _FresScale;
				float2 id13 = 0;
				float2 uv13 = 0;
				float voroi13 = voronoi13( coords13, time13, id13, uv13, 0 );
				float2 texCoord19 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float cos21 = cos( temp_output_15_0 );
				float sin21 = sin( temp_output_15_0 );
				float2 rotator21 = mul( texCoord19 - float2( 0.5,0.5 ) , float2x2( cos21 , -sin21 , sin21 , cos21 )) + float2( 0.5,0.5 );
				float simplePerlin2D18 = snoise( rotator21*232.1 );
				simplePerlin2D18 = simplePerlin2D18*0.5 + 0.5;
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( fresnelNode8 * _FresnelColor * ( voroi13 * simplePerlin2D18 ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = fresnelNode8;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_15_0 = ( _TimeParameters.x * _Speed );
				float time13 = temp_output_15_0;
				float2 coords13 = IN.ase_texcoord3.xy * _FresScale;
				float2 id13 = 0;
				float2 uv13 = 0;
				float voroi13 = voronoi13( coords13, time13, id13, uv13, 0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV8 = dot( IN.worldNormal, ase_worldViewDir );
				float fresnelNode8 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV8, _FresnelPower ) );
...
/*ASEBEGIN
Version=18800
7;124;1730;887;2065;-512.5;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;16;-1492,659.5;Inherit;False;Property;_Speed;Speed;3;0;Create;True;0;0;0;False;0;False;3.45;20.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;14;-1509,527.5;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-1328,941.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-1312,591.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;21;-1102,1029.5;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1462,830.5;Inherit;False;Property;_FresScale;FresScale;4;0;Create;True;0;0;0;False;0;False;41.35;19.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;13;-1077,500.5;Inherit;True;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.RangedFloatNode;10;-1055,121.5;Inherit;False;Property;_FresnelPower;FresnelPower;1;0;Create;True;0;0;0;False;0;False;0;5.66;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-1049,34.5;Inherit;False;Property;_FresnelScale;FresnelScale;0;0;Create;True;0;0;0;False;0;False;0;3.35;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;18;-844,804.5;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;232.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-1079,275.5;Inherit;False;Property;_FresnelColor;FresnelColor;2;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;207.9366,17.78267,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;8;-807,22.5;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-625,568.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-382,200.5;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=3932CC95E9DB33A87188D0DDB8D8D83060A572B8